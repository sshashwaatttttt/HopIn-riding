...
export const getPlatformDeepLinks = (pickup, dropoff) => {
  ...
  // 3. Rapido Bike & Auto: Uses registered host "open" to launch the native passenger app directly
