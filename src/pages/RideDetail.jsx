        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 md:p-8 border border-gray-200 dark:border-gray-800 shadow-2xl space-y-6 animate-in fade-in duration-200">
          ...
          <div className="pt-2">
            {isMember ? (
              ...
              <div className="w-full py-4 px-6 rounded-2xl bg-amber-500/20 border border-amber-500/40 text-amber-600 dark:text-amber-400 font-black text-xs uppercase tracking-wider text-center">
